...
function createFatalLogger(palette, options) {
...
function createContextLogger(palette, options) {
    const base = createColorino(palette, options);
    // Inherit all default methods from the base logger...
    const logger = Object.create(base); // Object.create uses `base` as the prototype.
...
//# sourceMappingURL=readme-examples.spec.js.map