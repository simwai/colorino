...
export const colorConverter = {
    ...
    rgba: {
        toRgb: rgbaToRgb,
        toAnsi16: (rgba) => rgbToAnsi16(rgbaToRgb(rgba)),
        toAnsi256: (rgba) => rgbToAnsi256(rgbaToRgb(rgba)),
    },
    hsl: {
        toAnsi16: (hsl) => rgbToAnsi16(hslToRgb(hsl)),
        toAnsi256: (hsl) => rgbToAnsi256(hslToRgb(hsl)),
    },
};
